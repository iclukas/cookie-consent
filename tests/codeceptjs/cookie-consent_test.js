...
Scenario('should work correctly', async function (I) {
  ...
  I.waitForVisible('.cookie-consent-popup', wait)
  I.waitForVisible('[data-cc-consent="statistics"]', wait)
  I.waitForVisible('[data-cc-consent="extern-media"]', wait)
  I.waitForVisible('.cookie-consent-save', wait)
  ...
  I.waitForInvisible('.cookie-consent-popup', wait)
  I.waitForInvisible('[data-cc-consent="statistics"]', wait)
  I.waitForInvisible('[data-cc-consent="extern-media"]', wait)
  I.waitForInvisible('.cookie-consent-save', wait)
  ...
  I.waitForVisible('.cookie-consent-popup', wait)
  I.waitForVisible('.cookie-consent-details', wait)
  I.click('.cookie-consent-details-close')
  I.waitForVisible('.cookie-consent-popup', wait)
  I.waitForInvisible('.cookie-consent-details', wait)
  ...
  I.click('.cookie-consent-details-close')
  I.waitForInvisible('.cookie-consent-popup', wait)
  I.waitForInvisible('.cookie-consent-controls', wait)
  I.waitForInvisible('.cookie-consent-details', wait)
  ...
  I.waitForVisible('.cookie-consent-popup', wait)
  I.waitForVisible('.cookie-consent-controls', wait)
  I.click('.cookie-consent-controls-toggle')
  I.waitForVisible('.cookie-consent-popup', wait)
  I.waitForInvisible('.cookie-consent-controls', wait)
